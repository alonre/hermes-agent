...
class TestFetchOpenRouterModels:
    ...
    def test_falls_back_to_static_snapshot_on_fetch_failure(self, monkeypatch):
        monkeypatch.setattr(_models_mod, "_openrouter_catalog_cache", None)
        # Stub the remote catalog manifest too — when it is reachable it
        # replaces OPENROUTER_MODELS as the fallback, and any tag drift
        # between manifest and in-repo snapshot fails this assert.
        with (
